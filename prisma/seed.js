...
const officialStores = [
    ...
    { code: 'T027', region: 'Marmara', city: 'İSTANBUL', name: 'MM İSTANBUL KAĞITHANE' },
    ...
    { code: 'T033', region: 'Marmara', city: 'İSTANBUL', name: 'MM MALL OF İSTANBUL' },
    ...
    { code: 'T046', region: 'Marmara', city: 'İSTANBUL', name: 'MM İSTANBUL LEVENT' },
    ...
    { code: 'T079', region: 'Marmara', city: 'İSTANBUL', name: 'MM BRANDİUM AVM' },
...
async function main() {
    console.log('Seeding official store data...');

    // Clear existing stores to ensure only official T-series remain
    ...
    for (const store of officialStores) {
        try {
            ...
            // console.log(`Processed ${store.code}`);
        } catch (e) {
            console.error(`Error processing ${store.code}:`, e);
        }
    }


    console.log(`Seeding completed. Processed ${officialStores.length} stores.`);
    ...
    console.log('Admin user created/updated: admin / 123456');
}
